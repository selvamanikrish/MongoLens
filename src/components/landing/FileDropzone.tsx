...
export const FileDropzone: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070b11] text-slate-100 flex flex-col justify-between relative overflow-hidden">
      ...
      <header className="px-4 sm:px-8 py-3.5 sm:py-4 border-b border-white/5 flex items-center justify-between relative z-10">
        <div className="flex items-center gap-2.5 sm:gap-3">
          <div className="w-8 sm:w-9 h-8 sm:h-9 rounded-xl bg-gradient-to-tr from-brand-700 to-brand-400 p-[1px] shadow-glow-brand flex items-center justify-center shrink-0">
          ...
          <div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              <span className="font-bold tracking-tight text-white font-mono text-sm sm:text-base">MongoLens</span>
              <span className="text-[9px] sm:text-[10px] uppercase font-mono tracking-wider px-1.5 py-0.5 rounded bg-brand-500/15 text-brand-400 border border-brand-500/30">
                v2.0
              </span>
            </div>
            <p className="text-[10px] sm:text-[11px] text-slate-400 leading-none">MongoDB Log Analyzer</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 text-xs text-slate-400">
          ...
          <div className="hidden lg:flex items-center gap-1.5 text-emerald-400/90 font-mono bg-emerald-950/40 px-2.5 py-1 rounded-full border border-emerald-500/20 text-xs">
          ...
          <button
            onClick={loadDemoLog}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-brand-500/20 hover:bg-brand-500/30 text-brand-300 border border-brand-500/40 transition-all font-medium text-xs shadow-glow-brand"
          >
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 py-6 sm:py-10 flex flex-col items-center justify-center relative z-10">
        {isParsing ? (
          <FileUploadProgress />
        ) : (
          <div className="w-full flex flex-col items-center text-center animate-fade-in">
            {/* Tagline */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-500/10 border border-brand-500/25 text-brand-300 text-[11px] sm:text-xs font-medium mb-4 sm:mb-5 shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" />
              <span>See what's slowing MongoDB down.</span>
            </div>

            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-3 sm:mb-4 leading-tight">
            ...
            <p className="text-slate-400 max-w-2xl text-xs sm:text-sm md:text-base mb-6 sm:mb-8 leading-relaxed px-1">
              Drop your <code className="text-slate-200 bg-white/10 px-1.5 py-0.5 rounded font-mono text-[11px] sm:text-xs">mongod.log</code> or{' '}
              <code className="text-slate-200 bg-white/10 px-1.5 py-0.5 rounded font-mono text-[11px] sm:text-xs">mongod.log.gz</code> to instantly
            ...
            <div
              ...
              className={`w-full max-w-2xl p-6 sm:p-10 rounded-2xl border-2 border-dashed transition-all duration-200 cursor-pointer group flex flex-col items-center justify-center relative bg-gradient-to-b from-[#0f172a]/90 to-[#0c1322]/90 backdrop-blur-md shadow-2xl ${
                isDragging
            ...
            >
              ...
              <div className="w-14 sm:w-16 h-14 sm:h-16 rounded-2xl bg-brand-500/10 border border-brand-500/30 flex items-center justify-center text-brand-400 mb-3 sm:mb-4 group-hover:scale-110 group-hover:bg-brand-500/20 transition-all duration-200 shadow-glow-brand">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mt-5 sm:mt-6 w-full max-w-xs sm:max-w-none">
              <button
                onClick={loadDemoLog}
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-brand-600 to-emerald-600 hover:from-brand-500 hover:to-emerald-500 text-slate-950 font-semibold text-xs transition-all shadow-glow-brand active:scale-95"
              >
                <Sparkles className="w-4 h-4" />
                <span>Load Realistic Demo Log</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </div>

            {/* Privacy & Feature Guarantees */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 max-w-2xl w-full mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-white/5 text-[11px] sm:text-xs text-slate-400">
              ...
              <div className="flex items-center justify-center gap-1.5 p-1.5 rounded-lg bg-white/[0.02]">
                <FileCode className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-brand-400 shrink-0" />
              ...
              <div className="flex items-center justify-center gap-1.5 p-1.5 rounded-lg bg-white/[0.02]">
                <Zap className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-amber-400 shrink-0" />
                <span>No Remote Upload</span>
              </div>
            </div>
          </div>
        )}
        ...
        {!isParsing && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-4 w-full max-w-4xl mt-8 sm:mt-12">
      ...
      <footer className="px-4 sm:px-8 py-4 sm:py-5 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 relative z-10 gap-3 text-center md:text-left">
        <div>
          <span>MongoLens • Modern Browser-Based MongoDB Diagnostic Tool</span>
          <span className="hidden sm:inline mx-2">•</span>
          <span className="block sm:inline text-slate-400 mt-1 sm:mt-0">100% Client-Side Privacy</span>
        </div>
